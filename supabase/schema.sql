...
('바이브코딩 강의, 개발에 대한 이해', '인공지능 관련 협회 임원진', '2026-06-15', 'education', '협회 임원진 대상 바이브코딩 개인 코칭 진행', null),
('고려대 진로 특강', '고려대학교', '2026-03-01', 'career_lecture', '고려대 학생 대상 AI 시대 커리어 전략 특강', null),
('업무자동화를 위한 바이브코딩 강의', '스타트업 대표', '2026-07-20', 'education', '스타트업 대표 대상 바이브코딩 1:1 코칭. 주요 데이터 대시보드로 구현', null),
('업무자동화를 위한 바이브코딩 강의', '대기업 임원', '2026-07-25', 'education', '대기업 임원 대상 바이브코딩 1:1 코칭. 실무 자동화 툴 직접 제작 및 조직 내 AI 도입 방향 논의', null);
