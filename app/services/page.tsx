...
const services = [
  ...
  {
    id: 'ai_advisory',
    title: 'Executive AI Advisory (AI활용 코칭)',
    tag: '임원 1:1',
    tagColor: 'bg-violet-50 text-violet-700',
    desc: '이미 AI는 쓰지만 업무에 제대로 못 붙이고 있는 임원·대표를 위한 1:1 코칭. 서비스 제작보다 지금 하는 업무를 AI로 자동화하는 데 집중합니다.',
    targets: [
      'AI 유료 결제는 하고 있지만 활용이 단순 질의응답 수준에 머문 분',
      '보고서·데이터 분석·문서 작업을 AI로 자동화하고 싶은 임원·대표',
      '바쁜 일정 속에서 본인의 실제 업무 데이터로 바로 실습하고 싶은 분',
    ],
    process: ['AI 활용 레벨 진단 및 사전 인터뷰', '개인 AI 업무환경 세팅', '실제 업무 데이터로 자동화 실습', '다음 단계 로드맵 설계'],
  },
  {
    id: 'lecture',
